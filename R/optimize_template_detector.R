...
#' parallel = 1, pb = TRUE, by.sound.file = FALSE, previous.output = NULL)
...
#' @param threshold Numeric vector of length > 1 with values between 0 and 1 specifying the correlation threshold for detecting signal occurrences (i.e. correlation peaks). Must be supplied. \strong{Several values should be supplied for optimization}.
...
optimize_template_detector <- function(template.correlations, reference, threshold, parallel = 1, pb = TRUE, by.sound.file = FALSE, previous.output = NULL){
