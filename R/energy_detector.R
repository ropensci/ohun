...
#' power = 1, thinning = 1, bp = NULL, smooth = 5, threshold = 5,
...
#' @param threshold Numeric vector of length 1 with a value between 0 and 1 specifying the amplitude threshold for detecting signal occurrences. Amplitude is represented as a percentage so 0 and 100 represent the lowest amplitude and highest amplitude respectively. Default is 5.
