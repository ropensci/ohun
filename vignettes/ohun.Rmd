...
# run detection
detection <- energy_detector(files = "simulated_1.wav", bp = c(1, 8), threshold = 0.5, min.duration = 500, path = tempdir(), pb = FALSE)
...
# run detection
detection <- energy_detector(files = "simulated_1.wav", bp = c(1, 8),  threshold = 0.5, min.duration = 1, max.duration = 500, path = tempdir(), pb = FALSE)
...
# Detecting 
detection <- energy_detector(files = "simulated_1.wav", bp = c(5, 8),  threshold = 0.5, min.duration = 1, path = tempdir(), pb = FALSE)
...
# Detect
detection <- energy_detector(files = "simulated_1.wav", bp = c(0, 6),  threshold = 0.5, min.duration = 1, path = tempdir(), pb = FALSE)
...
# detect sounds
detection <- energy_detector(files = "simulated_2.wav",  threshold = 0.5, min.duration = 1, path = tempdir(), pb = FALSE)
...
# detect sounds
detection <- energy_detector(files = "simulated_2.wav",  threshold = 0.5, min.duration = 1, path = tempdir(), pb = FALSE, hold.time = 200)
...
# detect sounds
detection <- energy_detector(files = "simulated_2.wav",  threshold = 0.5, min.duration = 1, path = tempdir(), pb = FALSE, smooth = 2)
