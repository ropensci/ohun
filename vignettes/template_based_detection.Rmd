...
This vignette details the use of template-based detection in [ohun](https://github.com/maRce10/ohun). The method is better suited for stereotyped sounds:
...
Template-based detection method is better suited for highly stereotyped sound events. As it doesn't depend on the signal-to-noise ratio it's more robust to higher levels of background noise. The procedure is divided in three steps:
